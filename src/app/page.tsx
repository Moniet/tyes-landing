            ...
            <div className="flex w-full flex-1 justify-between gap-10 flex-wrap">
              <div className="flex flex-col space-y-2">
                ...
                <a
                  ...
                  className="text-white/80 hover:text-white transition-colors duration-300 text-sm mb-2"
                >
                  Privacy Policy
                </a>
                <a
                ...
                <a
                  href="/event-waiver.pdf"
                  className="text-white/80 hover:text-white transition-colors duration-300 text-sm "
                >
                  Event Waiver
                </a>
                <a
                  href="/general-disclaimer.pdf"
                  className="text-white/80 hover:text-white transition-colors duration-300 text-sm "
                >
                  General Disclaimer
                </a>
                <a
                  href="/organizer-terms.pdf"
                  className="text-white/80 hover:text-white transition-colors duration-300 text-sm "
                >
                  Organizer Terms
                </a>
                <a
                  href="/community-guidelines.pdf"
                  className="text-white/80 hover:text-white transition-colors duration-300 text-sm "
                >
                  Community Guidelines
                </a>
                <a
                  href="/social-media-disclaimer.pdf"
                  className="text-white/80 hover:text-white transition-colors duration-300 text-sm "
                >
                  Social Media Disclaimer
                </a>
                <a
                  href="/sponsorship-waiver.pdf"
                  className="text-white/80 hover:text-white transition-colors duration-300 text-sm "
                >
                  Sponsorship Waiver
                </a>
                ...
                <div className="rounded-xl flex gap-2 items-start flex-col">
                  <div className="flex max-sm:flex-col w-full gap-2">
                    <input
                      ...
                      required
                      value={email2}
                      className=" h-9 px-3 placeholder:text-white/50 max-sm:text-center text-sm text-white border border-zinc-700 rounded-full focus:border-zinc-300 bg-zinc-800/30 transition-all ring-offset-1 outline-none focus:outline-none w-full md:w-1/2"
                    />
                    <button
                      disabled={!email2}
                      className="h-9 disabled:opacity-50 font-medium text-white flex text-sm px-5 py-1 justify-center items-center bg-brand rounded-full"
                    >
                      Submit
